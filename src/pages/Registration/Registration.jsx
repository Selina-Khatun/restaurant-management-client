...
const Registration = () => {
    ...
    return (
        <div>
            <section className="bg-gray-50 mt-15 dark:bg-gray-900">
                <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-[90vh] lg:py-0">

                    <div data-aos="zoom-in-up"  className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
